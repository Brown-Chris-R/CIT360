...
import org.cit360.android.model.User;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            userHashMap.put("User", mEmail);
            userHashMap.put("Password", mPassword);
            ...
            LinkedHashMap<String, String> loginParams = new LinkedHashMap<String, String>();
            loginParams.put("Command", "Login");
            loginParams.put("DataObject", userJSON);
            ...
            try {
                ...
                try {
                    ...
                    wr.writeBytes(getPostDataString(loginParams));
                    wr.flush();
                    wr.close();
                } catch (Exception e) {
                ...
                if (responseStatus.equals("Success")) {
                    String sessionId = con.getHeaderField("Session");
                    String userId = con.getHeaderField("UserId");
                    ...
                    editor.putString("SessionUserId", userId);
                    editor.commit();
                    return true;
                } else {
                    return false;
